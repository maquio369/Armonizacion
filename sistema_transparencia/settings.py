...
INSTALLED_APPS = [
    ...
    # Nuestras apps se agregarán aquí
    'apps.publico.apps.PublicoConfig',
...
ROOT_URLCONF = 'sistema_transparencia.urls'
...
WSGI_APPLICATION = 'sistema_transparencia.wsgi.application'
